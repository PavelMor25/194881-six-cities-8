...
function ReviewForm(): JSX.Element {
  ...
  const isDisabled = characters.length < 50 || rating === 0;
  ...
  return (
    <form className="reviews__form form" action="#" method="post">
      ...
      <textarea className="reviews__textarea form__textarea" id="review" name="review" onChange={({target}) => setCharacters(target.value)} placeholder="Tell how was your stay, what you like and what can be improved"></textarea>
